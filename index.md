...
sublead: Мы предоставляем доступ через систему автоматизированного интерфейса к базам данных. Мы охватываем темы госзакупок, организаций, статистики, банков, госфинансов и других. Мы создаем готовые API на заказ и предоставляем коммерческий доступ к данным, которые Вы хотели бы продавать.
...
hiw:
  ...
  subheading: API Crafter предоставляет рабочей системе клиента (его программному продукту) доступ к информации, содержащейся в имеющихся базах данных нашей компании, наших партнеров или на стороне клиента, для автоматизированного подключения
  list:
